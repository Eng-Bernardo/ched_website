      ...
      <div className="container mx-auto px-6">
        ...
        >
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="glass-card p-8 rounded-2xl h-full flex flex-col border border-white/10 glow-on-hover">
                <div className="flex items-center mb-6">
                  <img className="w-12 h-12 rounded-full mr-4 object-cover ring-2 ring-accent-purple/20" alt={testimonial.name} src={testimonial.avatar} />
                  <div>
